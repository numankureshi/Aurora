...
WebUI.click(findTestObject('Object Repository/Xpath/Page_Aurora/p_Single Page'))

WebUI.click(findTestObject('HomePage/MultiPage Article/Open cument'))

WebUI.setText(findTestObject('HomePage/MultiPage Article/Document body text'), 'This is edited')

WebUI.click(findTestObject('Object Repository/Xpath/Page_Aurora/span_Save Draft'))

WebUI.click(findTestObject('Object Repository/Xpath/Page_Aurora/path'))
...
WebUI.click(findTestObject('Object Repository/Xpath/Page_Aurora/ins_this document is edited'))
