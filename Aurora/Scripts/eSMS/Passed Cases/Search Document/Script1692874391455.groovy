...
WebUI.click(findTestObject('Object Repository/Xpath/Page_Aurora/button_Search'))
...
WebUI.waitForElementPresent(findTestObject('Xpath/Page_Aurora/Document Search'), 0)
