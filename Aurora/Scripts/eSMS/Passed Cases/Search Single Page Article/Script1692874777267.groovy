...
WebUI.click(findTestObject('Object Repository/Xpath/Page_Aurora/div_Procedures1'))

WebUI.waitForElementPresent(findTestObject('Xpath/Page_Aurora/Search Single Page'), 0)
