...
WebUI.click(findTestObject('HomePage/eSMS/Common Functions/Tiles/Manage Acknowledgement'))

WebUI.click(findTestObject('HomePage/Sean Testing Tile/Documents/Acknowledgements/Assign Position'))
