...
WebUI.waitForElementPresent(findTestObject('HomePage/eSMS/Common Functions/Tiles/Select File Upload button'), 0)

WebUI.uploadFile(findTestObject('HomePage/eSMS/Common Functions/Tiles/Select File Upload button'), '')
